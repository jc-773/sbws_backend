...
public class PlayerResponseContainer {
    ...
    public String draftKingsPlayerID;
    ...
    public String fantasyDraftPlayerID;

    @JsonProperty("UsaTodayPlayerID")
    public String usaTodayPlayerID;
