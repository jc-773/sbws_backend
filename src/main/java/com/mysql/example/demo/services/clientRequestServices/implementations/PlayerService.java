...
public class PlayerService implements IPlayerService {
    ...
    public ResponseEntity<PlayerProfileResponse> returnPlayerProfileFromBackend(String playerID,
        ...
        try {
            ...
            Map<String, Object> overallBasePlayerDashboard_NBADotCom_Map = processJsonForOverallBasePlayerDashboardMap(jsonString, playerID);
    ...
    private Map<String, Object> processJsonForOverallBasePlayerDashboardMap(String jsonString, String playerID) {
        ...
        ArrayList<Object> rowSetList =  readValue.resultSets.get(5).rowSet;
        ArrayList<String> headersList =  readValue.resultSets.get(5).headers;
